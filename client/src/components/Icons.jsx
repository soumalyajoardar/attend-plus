...
/*
  Cog / gear. The outline is the standard Feather-style 8-lobe cog, which is
  drawn on a full 24x24 grid (it touches the edges of the box). It's wrapped in
  a group scaled to 90% so it reads at the same optical size as the other icons
  here, with stroke-width bumped to 2 so that 0.9 x 2 lands back on the 1.8
  line weight the rest of the set uses.
*/
export const IconSettings = (p) => (
  <Icon {...p}>
    <g transform="translate(12 12) scale(0.9) translate(-12 -12)" strokeWidth={2}>
